  ...
  render() {
    return (
      <div className="projects">
        <h1>My Projects</h1>
        <p>This portfolio site is a project in and of itself, so <strong><a
        href="https://github.com/deannaswallow/Portfolio" target="_blank"
        ...
        click here</a></strong> to see the code for it.</p>
          ...
          version here.</a></strong>
          <br />
          <strong><a href="https://github.com/deannaswallow/angularjs-to-do"
          target="_blank" rel="noopener noreferrer">See the code for the Angular
          version here.</a></strong>
          <br />
          <strong><a href="https://github.com/deannaswallow/to-do-app"
          target="_blank" rel="noopener noreferrer">See the code for the vanilla
          JavaScript version here.</a></strong>
          <p className="project-desc">As was the case with BlocJams, there are
          three versions of this as well: React, Angular, and vanilla JavaScript.
          Gotta know the basics, right?</p>
      </div>
    );
  }
};
