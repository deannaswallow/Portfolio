    ...
    return (
      <div className="about">
        <h1>What I Want To Learn</h1>
          <p>I joke that I want to know <i>all</i> the things. Okay, it's not
          really a joke, but I'll break down the big topics I'd like to dive
          into:</p>
          <ul>
            <li>Node.js</li>
            <li>React Native</li>
